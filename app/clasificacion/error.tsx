...
export default function ClasificacionError({
	reset,
}: {
	...
	return (
		<div className="flex flex-col items-center justify-center gap-6 py-20 text-center">
			...
			<h2 className="font-display text-2xl font-bold uppercase tracking-wide">
				Error al cargar clasificacion
			</h2>
			<p className="max-w-md text-sm text-muted-foreground">
				No se pudo cargar la tabla de clasificacion. Puede ser un problema temporal con la base de datos.
			</p>
			<button
				onClick={reset}
